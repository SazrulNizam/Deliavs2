...
$courseurl = core_course_category::user_top() ? new moodle_url('../reportcard.php') : null;
$PAGE->navbar->add('Report Card', $courseurl);
$PAGE->navbar->add('Upload', new moodle_url('/course/newpage.php'));
if (!empty($search)) {
...
if (empty($searchcriteria)) {
    ...
    if ((can_edit_in_category() || !empty($usercatlist))) {
        $aurl = new moodle_url('superadmin/reportcard.php', $searchcriteria);
...
$PAGE->set_heading('Upload Report');
