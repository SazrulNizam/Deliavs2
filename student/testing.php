...
<label for="grade">Subject</label>
      ...
      <option value="Malay Language Comprenhension">Malay Language Comprehension</option>
      <option value="Malay Language Writing">Malay Language Writing</option>
      <option value="English Language Comprenhension">English Language Comprenhension</option>
      <option value="English Language Writing">English Language Writing</option>
