...
$PAGE->navbar->add('Recording Class', new moodle_url('vod.php'));


$PAGE->set_heading('Recording Class');
...
Successfully to add Recording</div>
<?php
...
Successfully to delete Recording</div>
<?php
  unset($_SESSION['message']);
}
?>
