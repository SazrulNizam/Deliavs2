...
<div class="col-md-12 video-container" data-toggle="modal" data-target=".bd-example-modal-lg">
    <div class ="video"><video width="800px" src="test.mp4#t=10"muted>
        </video>
</div>
</div>
...
<div onclick="pauseVid()" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-header">
            ...
            <video width="800px" id="myVideo" src="test.mp4#t=10" controls>
        </video>
    </div>
  </div>
</div>
